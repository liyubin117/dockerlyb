...
export PATH=$HADOOP_HOME/bin:$HADOOP_HOME/sbin:$HIVE_HOME/bin:${FLUME_HOME}/bin:${ZOOKEEPER_HOME}/bin:${HBASE_HOME}/bin:${PIG_HOME}/bin:${SCALA_HOME}/bin:${SPARK_HOME}/bin:${KAFKA_HOME}/bin:$PATH
export PS1='[\u@\H \w]\$'
